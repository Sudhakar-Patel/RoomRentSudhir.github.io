...
<style>
  body{
    background:url('assets/img/9eSk.gif');
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block text-warning">RoomRent</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="login_insert1.php" method="post">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="signup_form.php">Create an account</a></p>
                    </div>
                  </form>
