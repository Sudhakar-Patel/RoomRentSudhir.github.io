...
$location=$_SESSION['location'];
 ...
 $query="select * from rooms where location='$location'and category='bachelors'";
...
?>
   ...
   <h1 class="text-light"> Rooms in <span class="text-warning"><?php echo $key['location'] ?></span> </h1>
</div>
<!-- ----------------rooms section--------- -->
...
<!-- php section-------------------------- -->
    ...
    <div class="card col-md-3 col-6 m-5 " >
      ...
      <h6><?php echo $key['discription'] ?></h6>
...
if(!$connect){
 ...
 $query="select * from rooms where location='$location'and category='families'";
$result=mysqli_query($connect,$query);
if(!$result){
