...
?>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Update Customer Details</h5>
                    <!-- <p class="text-center small">Enter your personal details to create account</p> -->
                  </div>

                  <form class="row g-3 needs-validation" novalidate action="final_update_customer.php" method="post">
                    <div class="col-12">
                      <label for="yourName" class="form-label" >Your Name</label>
                      <input type="text" name="name" class="form-control" id="yourName" value="<?php echo $key['cname'] ?>" required>
      <input value="<?php echo   $key['id'];?>"type="hidden" class="form-control" id="name" name="id">
                    ...
                    <div class="col-12">
                      ...
                      <input type="email" name="email" class="form-control" id="yourEmail" value="<?php echo $key['email'] ?>"required>
                      <div class="invalid-feedback">Please enter a valid Email adddress!</div>
                    </div>

                    <div class="col-12">
                      <label for="yourContact" class="form-label">Mobile Number</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">+91</span>
                        <input type="number" name="contact" class="form-control" id="yourContact" value="<?php echo $key['contact'] ?>"required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="textarea" name="location" class="form-control" id="yourAddress"value="<?php echo $key['location'] ?>" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="username" class="form-control" id="yourUsername"value="<?php echo $key['username'] ?>" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="yourPassword" value="<?php echo $key['password'] ?>"required>
