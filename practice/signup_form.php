            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="signup_insert.php" method="post">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="number" name="contact" class="form-control" id="yourContact" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="textarea" name="location" class="form-control" id="yourAddress" required>
