...
?>
  ...
  <main id="main" class="main">
    ...
    <h1 class="text-center">Sold Rooms</h1>
...
<td><a class="btn btn-success" href="update.php?q=<?php echo $key['r_id'];?>">ADD</a>
<a class="btn btn-danger" href="delete.php?q=<?php echo   $key['r_id'];?>">Delete</a></td>
