...
<div class="container p-3">
    ...
    <form action="final_update_seller_room.php"method="post" enctype="multipart/form-data">
  ...
  <div class="form-group row pt-2" >
    ...
    <div class="col-sm-10">
      <input type="file" class="form-control" id="image1" name="image"value='<img src="<?php echo $key['image'] ?>">'placeholder="choose images">
    </div>
  ...
  <div class="form-group row p-2">
    ...
    <div class="col-sm-10" >
      <input type="radio" name="bathroom" id="park" value="yes">Yes
      <input type="radio" name="bathroom" id="park" value="no">No
    </div>
  </div>
   <div class="form-group row p-2">
