...
$bachelors=$_SESSION['category'];
$families=$_SESSION['category1'];
$both=$_SESSION['category2'];
?>

<div class="container">
   <h1 class="text-light"> Rooms in <span class="text-warning"><?php echo $location ?></span> </h1>
</div>
<!-- ----------------rooms section--------- -->
...
if(!$connect){
 ...
 $query="select * from rooms where location='$location'and (category='$bachelors' or category='$both')";
...
if(!$connect){
 ...
 $query="select * from rooms where location='$location'and (category='$families' or category='$both')";
$result=mysqli_query($connect,$query);
if(!$result){
