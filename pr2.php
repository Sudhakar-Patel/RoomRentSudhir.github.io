...
<head>
  ...
  <title>Rooms Rent Home page</title>
...
if(!$connect){
 ...
 $query="select * from rooms_visit where location='mandir hasoud'";
...
?>
        ...
        <div class="carousel-item active">
            <img style="height: 500px;"src="<?php echo $key['image'] ?>" class="d-block w-100 " alt="...">
