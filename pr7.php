...
<body style="background:linear-gradient( to left, rgb(230, 14, 14),rgb(46, 43, 43),black)">
 ...
 <!-- End Header -->
<div class="container">
   <h1 class="text-light"> Rooms in <span class="text-warning">Telibandha</span> </h1>
</div>
<!-- ----------------rooms section--------- -->
...
if(!$connect){
 ...
 $query="select * from rooms where location='telibandha'and category='bachelors'";
...
if(!$connect){
 ...
 $query="select * from rooms where location='telibandha'and category='families'";
$result=mysqli_query($connect,$query);
if(!$result){
